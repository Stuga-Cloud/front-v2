...
const features = [
    {
        ...
        description:
            "Secure database where data is encrypted and decrypted client-side, ensuring privacy and protection even if the provider is compromised.",
        icon: Key,
        bgColor: "bg-red-600",
    },
    {
        ...
        description:
            "Central repository to store and distribute container images, facilitating application sharing and deployment.",
        icon: Boxes,
        bgColor: "bg-lime-600",
    },
    {
                ...
                <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
                    <figure className="relative isolate pt-6 sm:pt-12">
                        ...
                        <blockquote className="text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                            <p>
                                A developer's dream. An enthralling journey
                                through the mysteries of technology, where cloud
                                providers strive to reach new levels of
                                unreliability and frustration. Amidst this
                                chaotic landscape, Stuga Cloud stands tall,
...
const Feature = ({ feature }: FeatureProps) => (
    <div key={feature.name} className="relative pl-16">
        <dt className="text-base font-semibold leading-7 text-gray-900">
            <div
                className={`absolute left-0 top-0 flex h-10 w-10 items-center justify-center rounded-lg ${feature.bgColor}`}
            >
                <feature.icon
